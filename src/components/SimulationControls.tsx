...
const SCENARIO_PRESETS: ScenarioPreset[] = [
  {
    ...
    description: "India bans API exports — devastating multi-tier cascade with inventory seizure over 20 weeks",
    config: {
  ...
  },
  {
    ...
    description: "Nationwide lockdown shuts tier 3 + tier 2 simultaneously with sustained warehouse lockdowns for 14 weeks",
    config: {
  ...
  },
  {
    id: "us_hurricane",
    name: "US Hurricane",
    description: "Catastrophic physical destruction of Tier 1 facilities — sharp V-dip with fast emergency recovery over 8 weeks",
    config: {
  ...
  },
  {
    id: "cyber_attack",
    name: "Cyber Attack",
    description: "Ransomware briefly freezes Tier 1 systems — minimal lasting impact, 4-week recovery",
    config: {
  ...
  },
  {
    id: "quality_crisis",
    name: "Quality Crisis",
    description: "Rolling contamination recalls destroy finished product inventory in waves over 24 weeks",
    config: {
